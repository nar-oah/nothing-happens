...
<div class="flex h-[78px] w-[64px] flex-col items-start overflow-hidden px-5">
	...
	<p class="typo-document-clause-number w-full">{value}</p>
	<div class="typo-newspaper-body flex w-full items-start justify-center whitespace-nowrap"><span>{direction}</span><span>{magnitude}</span></div>
</div>
