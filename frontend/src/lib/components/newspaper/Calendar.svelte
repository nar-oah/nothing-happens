...
<div class="flex h-full w-full items-center gap-8 overflow-hidden px-8">
	...
	<div class="flex min-w-0 flex-1 flex-col items-start gap-[3px] overflow-hidden">
		<div class="flex w-full shrink-0 items-start overflow-hidden bg-surface-indigo px-5 py-2">
			<p class="typo-newspaper-caption min-w-0 flex-1 text-surface-amber">{isYinMonth ? '陰月判讀' : '陽月判讀'}</p>
		</div>
		...
		<div class="flex w-full shrink-0 items-center gap-12 overflow-hidden">
			...
			<div class="flex w-[12px] shrink-0 flex-col items-center justify-center bg-ink-primary"><p class="typo-newspaper-caption shrink-0 text-surface-amber whitespace-nowrap">宜</p></div>
		</div>
		...
		<div class="flex w-full shrink-0 items-center gap-12 overflow-hidden">
			...
			<div class="flex w-[12px] shrink-0 flex-col items-center justify-center bg-ink-primary"><p class="typo-newspaper-caption shrink-0 text-surface-amber whitespace-nowrap">忌</p></div>
		</div>
	</div>
</div>
