...
const STATE_TYPES: Dictionary = {
	...
	"ActiveProposalState": ActiveProposalState,
	"ActiveBillState": ActiveBillState,
	"DraftBillState": DraftBillState,
	"SavedBillState": SavedBillState,
	"PolicyState": PolicyState,
	"EventState": EventState,
	"OfficeVisitState": OfficeVisitState,
	"SeatState": SeatState,
	"RaceState": RaceState,
